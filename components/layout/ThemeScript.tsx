 ...
 *
 * Also resolves the admin rail's collapsed state, for the same reason:
 * resolving it here is what lets the rail render at the right width on the
 * server and stay a server component.
 *
